...
@enderror">
                            ...
                            <!-- Alternate Phone -->
                            <div>
                                <label for="alternate_phone" class="block text-sm font-medium text-gray-700">Alternate
                                    Phone</label>
                                <input type="text" wire:model="alternate_phone" id="alternate_phone"
                                    oninput="
                                let val = this.value;
                            ...
                            <!-- Lead Source -->
                            <div>
                                <label for="lead_source_id" class="block text-sm font-medium text-gray-700">Lead Source
                                    <span class="text-red-500">*</span></label>
                                <select wire:model="lead_source_id" id="lead_source_id"
                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md @error('lead_source_id') border-red-500 @enderror">
                            ...
                            <!-- Lead Status -->
                            <div>
                                <label for="lead_status_id" class="block text-sm font-medium text-gray-700">Lead Status
                                    <span class="text-red-500">*</span></label>
                                <select wire:model="lead_status_id" id="lead_status_id"
                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md @error('lead_status_id') border-red-500 @enderror">
                            ...
                            <!-- Assigned To -->
                            <div>
                                <label for="assigned_to" class="block text-sm font-medium text-gray-700">Assign
                                    To</label>
                            ...
                            <div>
                                <label for="product_interest" class="block text-sm font-medium text-gray-700">Product
                                    Interest</label>
                                <input type="text" wire:model="product_interest" id="product_interest"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>

                            <!-- Estimated Value -->
                            <div>
                                <label for="estimated_value" class="block text-sm font-medium text-gray-700">Estimated
                                    Value (₹)</label>
                                <input type="number" step="0.01" wire:model="estimated_value" id="estimated_value"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>

                            <!-- Next Follow-up Date -->
                            <div>
                                <label for="next_follow_up_date" class="block text-sm font-medium text-gray-700">Next
                                    Follow-up Date</label>
                                <input type="date" wire:model="next_follow_up_date" id="next_follow_up_date"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                    </div>

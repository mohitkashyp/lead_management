                                    ...
                                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <div class="mt-3">
                                                    <button type="button" wire:click="quickConvertLead"
                                ...
                                @if ($customer)
                                    <div class="bg-green-50 border-l-4 border-green-400 p-4">
                                        <div class="flex">
                                            ...
                                            <div class="ml-3">
                                                <h3 class="text-sm font-medium text-green-800">{{ $customer->name }}
                                                </h3>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                                ...
                                                <div class="md:col-span-3">
                                                    ...
                                                    <select wire:model.live="items.{{ $index }}.product_id"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('items.' . $index . '.product_id') border-red-500 @enderror">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        min="1"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('items.' . $index . '.quantity') border-red-500 @enderror">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        step="0.01" min="0"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('items.' . $index . '.price') border-red-500 @enderror">
                                            ...
                                            @if (isset($item['quantity']) && isset($item['price']) && isset($item['product_id']))
                                                @php
                                                    ...
                                                    if ($gst_type === 'inclusive') {
                                                        ...
                                                        $itemTotal = $itemSubtotal; // already includes tax
                                                    } else {
                                                ...
                                                <div class="mt-2 text-right text-sm">
                                                    <div class="text-gray-600">Subtotal:
                                                        ₹{{ number_format($itemSubtotal, 2) }}</div>
                                                    <div class="text-gray-600">Tax ({{ $taxRate }}%):
                                                        ₹{{ number_format($itemTax, 2) }}</div>
                                                    <div class="font-medium text-gray-900">Item Total:
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div>
                                        ...
                                        <textarea wire:model="shipping_address" id="shipping_address" rows="3"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('shipping_address') border-red-500 @enderror"></textarea>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model="shipping_city" id="shipping_city"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('shipping_city') border-red-500 @enderror">
                                            @error('shipping_city')
                                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div>
                                            <label for="shipping_state"
                                                class="block text-sm font-medium text-gray-700">State <span
                                                    class="text-red-500">*</span></label>
                                            <input type="text" wire:model="shipping_state" id="shipping_state"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('shipping_state') border-red-500 @enderror">
                        ...
                        <div class="bg-white shadow rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select wire:model.live="gst_type"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Shipping Cost
                                            (₹)</label>
                                        <input type="number" wire:model.live="shipping_cost" step="0.01"
                                            min="0"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    </div>
                                    ...
                                    <div class="pt-3 border-t border-gray-200">
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="text-xl font-bold text-indigo-600">₹{{ number_format($total, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white shadow rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                @if ($available_shipping_providers->count() > 0)
                                    <div class="space-y-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700">Shipping
                                                Provider</label>
                                            <select wire:model.live="selected_shipping_provider_id"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                <option value="">Select Provider (Optional)</option>
                                                @foreach ($available_shipping_providers as $provider)
                                                    <option value="{{ $provider->id }}">{{ $provider->display_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <p class="mt-1 text-xs text-gray-500">Choose a shipping provider to create
                                                shipment automatically</p>
                                        </div>
                                                    ...
                                                    <div class="ml-3 flex-1">
                                                        ...
                                                        <div class="mt-3">
                                                            <label class="flex items-center">
                                                                <input type="checkbox" wire:model="create_shipment"
                                                                    class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4">
                                                                <span class="ml-2 text-sm font-medium text-blue-800">
                                                                    Create shipment on
                                                                    {{ $shipping_provider_selected->display_name }}
                                                                    automatically
                                                                </span>
                                                            </label>
                                                            <p class="ml-6 mt-1 text-xs text-blue-600">
                                                                When checked, shipment will be created on
                                                                {{ $shipping_provider_selected->display_name }} when
                                                                order is saved
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="flex">
                                                        ...
                                                        <div class="ml-3">
                                                            <p class="text-sm text-green-700">
                                                                <strong>Shipment will be created
                                                                    automatically</strong><br>
                                                                Order will be synced with
                                                                {{ $shipping_provider_selected->display_name }} and
                                ...
                                @else
                                    <div class="rounded-md bg-yellow-50 p-4">
                                        <div class="flex">
                                            ...
                                            <div class="ml-3">
                                                <h3 class="text-sm font-medium text-yellow-800">No Shipping Providers
                                                    Configured</h3>
                                                <div class="mt-2 text-sm text-yellow-700">
                                                    <p>Please configure shipping providers in organization settings to
                                                        enable automatic shipment creation.</p>
                                                    @if (auth()->user()->isAdmin())
                                                        <a href="{{ route('organizations.edit', $organization) }}"
                                                            class="font-medium underline text-yellow-700 hover:text-yellow-600 mt-2 inline-block">

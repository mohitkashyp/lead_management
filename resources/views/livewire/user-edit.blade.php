            ...
            <form wire:submit.prevent="save">
                <div class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3">
                       {{--  <a href="{{ route('organization.users.list') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            Cancel
                        </a> --}}
